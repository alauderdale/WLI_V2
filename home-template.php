 ...
 <section id="home" class="clearfix section">
     ...
     <div class="page wrapped">
         ...
         <div class="home-inner">
            <div class="click-rabbit-link"></div>
             ...
             <div class="home-col">
                 <h2 class="home-like-title">Shop</h2>
                 <?php
                $productloop = new WP_Query( array( 'post_type' => 'product') );
                 ?>
...
<!--         register custom post type for tequila-->
 ...
 <section id="press" class="clearfix section">
     <div class="wrapped">
         ...
         <div class="press-container" id="media-contain" class="clearfix">
             <?php
